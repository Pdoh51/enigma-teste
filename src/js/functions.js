...
const _INTRO_GIFS = {
    ...
    bracoEsticado: { cabFalando: "cabeca-braco-esticado-falando.gif", cabIdle: "cabeca-braco-esticado.gif", hFalando: "hiitsumo-frente-seria-falando.gif", hIdle: "hiitsumo-frente-seria.gif", salvarAudio: false },
    ...
    bracoMecanico: { cabFalando: "", cabIdle: "", hFalando: "braco-mecanico.png", hIdle: "braco-mecanico.png", salvarAudio: false },
};

function dispararAvancoDepoisDeDigitacao() {
    const botaoApertar = document.querySelector(".apertar");
    if (!botaoApertar) return;
...
function digitarMensagemIntro(texto, elementoId, estado = "normal", velocidade = 40) {
    ...
    pulando = false;
    digitando = true;
    avancarAposTerminarDigitacao = false;
    elemento.textContent = "";
    elemento.style.display = "block";
    elemento._introInterval = null;
    ...
    const parar = () => {
        if (elemento._introInterval) {
            clearInterval(elemento._introInterval);
        }
        elemento._introInterval = null;
        digitando = false;
        ...
        if (avancarAposTerminarDigitacao) {
            avancarAposTerminarDigitacao = false;
            dispararAvancoDepoisDeDigitacao();
        }
    };

    let i = 0;
    elemento._introInterval = setInterval(() => {
        if (pulando) {
...
const _BOSS_GIFS = {
    ...
    Uno: { cabFalando: "", cabIdle: "", hFalando: "Uno.png", hIdle: "Uno.png" },
    UnoFeliz: { cabFalando: "cabeca-feliz-falando.gif", cabIdle: "cabeca-feliz.gif", hFalando: "Uno.png", hIdle: "Uno.png" },
    UnoSemBrilho: { cabFalando: "", cabIdle: "", hFalando: "Uno-sem-brilho.png", hIdle: "Uno-sem-brilho.png" },
    UnoBeicinho: { cabFalando: "cabeca-beicinho1-falando.gif", cabIdle: "cabeca-beicinho1.gif", hFalando: "Uno.png", hIdle: "Uno.png" },
    computador: { cabFalando: "cabeca-falando.gif", cabIdle: "cabeca.gif", hFalando: "computador.png", hIdle: "computador.png" },
};
